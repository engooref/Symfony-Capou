 ...
 */
final class Version20210504122928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE operateur (id INT AUTO_INCREMENT NOT NULL, id_groupe_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, reset_token VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_B4B7F99DE7927C74 (email), INDEX IDX_B4B7F99DFA7089AB (id_groupe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
